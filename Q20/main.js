...
these items.*/
var riverList = ["River Indus", "River Chanab", "River Jehlum", "River Ravi", "River Sutlej"];
console.log("List  River of Pakistan");
riverList.forEach(function (river) { return console.log(river); });
